...
eb = Button(text="=",fg="RED",font="Verdana 14 bold",width=14,command=hesapla)
eb.place(x = 20, y = 250)

clear = Button(text="C",font="Verdana 14 bold",width=2, command=temizle)
clear.place(x = 120, y = 200)
